export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'banaandbean',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Banaandbean',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'banaandbean.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://banaandbean.com',
